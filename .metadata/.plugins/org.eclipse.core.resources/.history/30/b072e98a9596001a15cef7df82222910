...
<meta name="description" content="제주렌트카 가격비교 1위, 제주도 렌트카 실시간 예약, 최저가 보장제, 완전자차 보험, 슈퍼자차, 무제한 보장 프리미엄 서비스">
<meta name="keywords" content="제주도렌트카, 제주렌트카, 제주렌트카추천, 제주렌트카가격비교사이트, 제주렌트카가격비교, 제주렌트카1위, 제주렌트카이용후기, 제주패스렌트카, 제주렌트카 완전자차, 렌트카보험, 최저가, 완전자차 보험, 슈퍼자차">
...
<meta property="og:title" content="제주패스렌트카 - 압도적 1위, 품질만족 2년연속 대상">
	...
	collapse();
			...
			<script type="application/ld+json">
			{
				...
				"url": "https://www.jejupassrent.com/",
					...
					"image": "https://www.jejupassrent.comstatic/images/seo/jejupassrent_basic5.png",
				
				"name": "제주패스렌트카 - 제주도 렌트카 실시간 가격비교",
				"description": "제주렌트카 가격비교 1위, 제주도 렌트카 실시간 예약, 최저가 보장제, 완전자차 보험, 슈퍼자차, 무제한 보장 프리미엄 서비스",
				"keywords": "제주도렌트카, 제주렌트카, 제주렌트카추천, 제주렌트카가격비교사이트, 제주렌트카가격비교, 제주렌트카1위, 제주렌트카이용후기, 제주패스렌트카, 제주렌트카 완전자차, 렌트카보험, 최저가, 완전자차 보험, 슈퍼자차",
				"publisher": "제주패스렌트카",
				"potentialAction": {
					"@type": "SearchAction",
					"target": "https://www.jejupassrent.com/home/search/list.do?vhctySeCode=01,02,03,04,05,06,07&dataFillter3={searchCarName}",
					"query-input": "name=searchCarName"
				}
			}
			</script>
...
<span itemscope="" itemtype="http://schema.org/Organization">
  ...
  <a itemprop="sameAs" href="https://www.facebook.com/jejupass"></a>
  <a itemprop="sameAs" href="https://www.instagram.com/jejumatzip/"></a>
  <a itemprop="sameAs" href="https://blog.naver.com/jejubnf"></a>
</span>
		...
		window.criteo_q.push(
		         { event: "setAccount", account: 46385},
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-PRXWF6X');</script>
    <!-- End Google Tag Manager -->

    <!-- Google Tag Manager (noscript) -->
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PRXWF6X"
...
<script src="static/js/date.format.js" type="text/javascript"></script>

<script src="static/js/bw.lab.alphanumeric-1.0.js" type="text/javascript"></script>
<script src="static/js/bw.lab.money-1.1.js" type="text/javascript"></script>
<script src="static/js/bw.lab.validator-1.5.js" type="text/javascript"></script>
<script>					
$( document ).ready( function(){
	fitHeight();
});
...
<p>연락처 입력이나 결제 없이<br>모바일 카드 / 쿠폰만 보여주시면<br>현장에서 바로 할인해드립니다.</p>
	...
	<ul class="curation">
		<li class="large" style="text-align:center;">
			...
			<!-- <span>전기차 렌트하고</span>
			<p>제주도에 202,500그루의 나무를 심어주세요.<span class="underLine"></span></p>
			<a href="/home/search/list.do?vhctySeCode=08&insrncApplcCode=02">전기차 캠페인 자세히 보기</a> -->
		</li>
