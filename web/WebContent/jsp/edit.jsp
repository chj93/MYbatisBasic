			...
			<div id="contentsWrap" class="contentsWrap">
				<div class="contents">
					...
					<div class="btnSet clfix mgb15">
						<span class="fr">
							<span class="button"><a href="javascript:sendData()">저장</a></span>
					...
					<form action="insert.jsp" name="edit" method="post" enctype="multipart/form-data" >
					<table class="bbsWrite">
						...
						<tr>
							...
							<td>
								...
								<input type="password" name="password" class="inputText" size="50" />
